...
@Component
public class GreaterConverter extends ComparisonNodeConverter {

    protected GreaterConverter() {
        super(Operators.GREATER);
    }

    @Override
    protected Predicate doConvert(Expression expression, List<Comparable> arguments, CriteriaBuilder criteriaBuilder) {
        return criteriaBuilder.greaterThan(expression, arguments.get(0));
    }
}
